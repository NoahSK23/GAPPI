<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Precedent_withImge.aspx.cs" Inherits="GAPPI_Demo.Precedent_noImge" %>
        ...
        <div class="d-flex justify-content-center flex-column align-items-center mt-1">
            <div class="d-flex justify-content-between w-75">
                <div style="text-align: left;">
                    <asp:LinkButton ID="btnBack" runat="server" ForeColor="#222222">
                        <img class="pr-2" src="/Images/BackArrow.png" height="13">
                        Back
                    </asp:LinkButton>
                </div>
                <div style="text-align: right;">
                    <asp:LinkButton ID="btnPrevious" runat="server" ForeColor="#899197">Previous</asp:LinkButton>
                    <span>|</span>
